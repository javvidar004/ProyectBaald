...
/// </summary>
/// <param name="nombre">Nombre del ladrón</param>
/// <param name="genero">Género del ladrón</param>
/// <param name="raza">Raza del ladrón</param>
/// <param name="orientacion">Orientación del ladrón</param>
/// <param name="clase">Clase del ladrón</param>
Ladron::Ladron(string nombre, string genero, string raza, string orientacion, int clase) : Personaje(nombre, genero, raza, orientacion, clase)
{
	...
	// Inicialización del equipamiento y habilidades del ladrón.
	...
	_equip[4].nombre = "Botas de Ladrón";
		_equip[4].costo = 450;
	...
	_equip[6].nombre = "Túnica de Sigilo";
		_equip[6].costo = 800;
	...
	_equip[8].nombre = "Máscara de Bandido";
		_equip[8].costo = 550;
...
/// <returns>El equipamiento del ladrón en la posición dada</returns>
...
/// <summary>
/// Aumenta el daño del personaje en un 30%, reduce el daño enemigo en un 20% y activa la habilidad 2 durante 5 turnos.
/// </summary>
