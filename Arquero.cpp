...
/// </summary>
void Arquero::GastarPuntosDeHabilidad()
{
	int opcion;
...
Equipamiento Arquero::getEquipo(int n)
{
	Equipamiento aux;
	aux.nombre = "";
	aux.costo = 0;
...
Habilidades Arquero::getHabilidades(int n)
{
	Habilidades aux;
...
void Arquero::setEquipamiento(int n, bool desbloqueado, bool enUso)
{
...
void Arquero::setHabilidades(int n, bool disponible, int turnos)
{
...
void Arquero::setItems(int n, int cantidad)
{
...
/// </summary>
void Arquero::habilidad1()
{
	setAumentoDaño(getAumentoDaño() + 0.3);
}

/// <summary>
/// Aumenta el daño del personaje en un 30% y activa la habilidad 2 durante 7 turnos.
/// </summary>
void Arquero::habilidad2()
{
	setAumentoDaño(getAumentoDaño() + 0.3);
	setHabilidades(1, true, 7);
}

/// <summary>
/// Activa la habilidad 3 durante 5 turnos.
/// </summary>
void Arquero::habilidad3()
{
	setHabilidades(2, true, 5);
}

/// <summary>
/// Elimina la habilidad 1 y aumenta el daño base si estaba activa.
/// </summary>
void Arquero::eliminarHabilidad1()
{
...
/// </summary>
void Arquero::eliminarHabilidad2()
{
...
/// </summary>
void Arquero::eliminarHabilidad3()
{
...
void Arquero::CambioDeEquipo(int indice)
{
	for (int i = 0; i < 9; i++) {
		if (indice != i)
		{
