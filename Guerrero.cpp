...
Guerrero::Guerrero(string nombre, string genero, string raza, string orientacion, int clase) : Personaje(nombre, genero, raza, orientacion, clase) 
{
	//A = : Armadura, B = Arma, C = Botas, D = Amuleto, E = Casco.
	//B y D aumentan daño
	//A, C y E reducen daño

	_equip[0].nombre = "Espada";
		_equip[0].costo = 0;
		_equip[0].desbloqueado = true;
		_equip[0].enUso = true;
		_equip[0].tipo = 'B';
		_equip[0].cambioDaño = 0.0;
	_equip[1].nombre = "Hacha de Batalla";
		_equip[1].costo = 800;
		_equip[1].desbloqueado = false;
		_equip[1].enUso = false;
		_equip[1].tipo = 'B';
		_equip[1].cambioDaño = 0.2;
	_equip[2].nombre = "Casco de Guerrero";
		_equip[2].costo = 600;
		_equip[2].desbloqueado = false;
		_equip[2].enUso = false;
		_equip[2].tipo = 'E';
		_equip[2].cambioDaño = 0.1;
	_equip[3].nombre = "Armadura Reforzada";
		_equip[3].costo = 1000;
		_equip[3].desbloqueado = false;
		_equip[3].enUso = false;
		_equip[3].tipo = 'A';
		_equip[3].cambioDaño = 0.1;
	_equip[4].nombre = "Botas con Púas";
		_equip[4].costo = 550;
		_equip[4].desbloqueado = false;
		_equip[4].enUso = false;
		_equip[4].tipo = 'C';
		_equip[4].cambioDaño = 0.1;
	_equip[5].nombre = "Escudo de Batalla";
		_equip[5].costo = 750;
		_equip[5].desbloqueado = false;
		_equip[5].enUso = false;
		_equip[5].tipo = 'D';
		_equip[5].cambioDaño = 0.2;
	_equip[6].nombre = "Botas de Guerra";
		_equip[6].costo = 650;
		_equip[6].desbloqueado = false;
		_equip[6].enUso = false;
		_equip[6].tipo = 'C';
		_equip[6].cambioDaño = 0.2;
	_equip[7].nombre = "Corona de Guerrero";
		_equip[7].costo = 700;
		_equip[7].desbloqueado = false;
		_equip[7].enUso = false;
		_equip[7].tipo = 'E';
		_equip[7].cambioDaño = 0.2;
	_equip[8].nombre = "Espada del Gladiador";
		_equip[8].costo = 850;
...
/// </summary>
void Guerrero::GastarPuntosDeHabilidad()
{
	int opcion;
...
Equipamiento Guerrero::getEquipo(int n)
{
	Equipamiento aux;
	aux.nombre = "";
	aux.costo = 0;
...
Habilidades Guerrero::getHabilidades(int n)
{
	Habilidades aux;
...
void Guerrero::setEquipamiento(int n, bool desbloqueado, bool enUso)
{
...
void Guerrero::setHabilidades(int n, bool disponible, int turnos)
{
...
void Guerrero::setItems(int n, int cantidad)
{
...
/// </summary>
void Guerrero::habilidad1()
{
	setAumentoDaño(getAumentoDaño() + 0.3);
}

/// <summary>
/// Reduce el daño del enemigo en un 20% y activa la habilidad 2 durante 5 turnos.
/// </summary>
void Guerrero::habilidad2()
{
	setReduccionDaño(getReduccionDaño() - 0.2);
	setHabilidades(1, true, 5);
}

/// <summary>
/// Activa la habilidad 3 durante 7 turnos y aumenta el daño en un 35%.
/// </summary>
void Guerrero::habilidad3()
{
	setAumentoDaño(getAumentoDaño() + 0.35);
...
/// </summary>
void Guerrero::eliminarHabilidad1()
{
...
/// </summary>
void Guerrero::eliminarHabilidad2()
{
...
/// </summary>
void Guerrero::eliminarHabilidad3()
{
...
void Guerrero::CambioDeEquipo(int indice)
{
	for (int i = 0; i < 9; i++) {
		if (indice != i)
		{
